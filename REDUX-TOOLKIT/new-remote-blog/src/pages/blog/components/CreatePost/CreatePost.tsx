...
const intitialState: Omit<Post, 'id'> = {
  title: '',
  description: '',
  publishDate: '',
  featuredImage: '',
...
export default function CreatePost() {
  const [formData, setFormData] = useState<Omit<Post, 'id'> | Post>(intitialState)
  ...
  return (
    <>
      <label
        className='mb-2 block text-3xl font-medium text-gray-900 dark:text-gray-300'>
        {Boolean(postId) ? "Update A Blog" : "Add"}
      </label>
      <form onSubmit={handleSubmit} >
        ...
        <div className='mb-6'>
          <label htmlFor='publishDate' className={classNames('mb-2 block text-sm font-medium  dark:text-gray-300', {
          ...
          <input
            ...
            className={classNames(
              'block w-56 rounded-lg border 0 p-2.5 text-sm  focus:outline-none ',
              {
                ...
                'border-gray-300 bg-gray-5 text-gray-900 focus:border-blue-500 focus:ring-blue-500'
                  : !Boolean(errorForm?.publishDate),
              })}
            placeholder='Title'
            required
        ...
        <div className='mb-6 flex items-center'>
          <input
            id='publish' type='checkbox' className='h-4 w-4 focus:ring-2 focus:ring-blue-500'
